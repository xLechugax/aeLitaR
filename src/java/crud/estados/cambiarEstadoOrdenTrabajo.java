 ...
 * @author Lechuga
 */
@WebServlet(name = "cambiarEstadoOrdenTrabajo", urlPatterns = {"/cambiarEstadoOrdenTrabajo"})
public class cambiarEstadoOrdenTrabajo extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                String motivo = ""+hs.getAttribute("nombreUsuario")+" cambió la Orden de Trabajo al estado "+nombreEstado;
                String sql = "INSERT INTO cambio_estado (`motivo`, `idOrdenTrabajo`, `idEmpresa`) VALUES (?,?,?)";
                ...
                String sqlUpdateTarea = "UPDATE aelita.orden_trabajo SET estado=? WHERE idOrdenTrabajo=?";
                PreparedStatement pstUpdateTarea = conn.prepareStatement(sqlUpdateTarea);
                pstUpdateTarea.setString(1, idEstado);
                pstUpdateTarea.setString(2, idOrdenTrabajo);
