 ...
 * @author Lechuga
 */
@WebServlet(name = "gestorAreasDepartamentosAgregar", urlPatterns = {"/gestorAreasDepartamentosAgregar"})
public class gestorAreasDepartamentosAgregar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                String sql = "insert into area_departamento (nombreAreaDepartamento,detalleAreaDepartamento,idEmpresa) values (?,?,?)";
